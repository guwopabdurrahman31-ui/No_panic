...
- `release/panic-pass-sos-v1.0.10.aab`: 최신 Google Play 업데이트용 서명 AAB
- `release/panic-pass-sos-v1.0.10.apk`: 최신 실제 기기 설치 확인용 서명 APK
...
- `assets/screenshots/`: 1080×1920 휴대전화 스크린샷 5장
